...
$(document).ready(function() {
    ...
    inputs.forEach(function(input) {
        input.addEventListener('input', function() {
            ...
            localStorage.setItem('teacher_assignment_draft', JSON.stringify(data));
        });
    });
    
    // Load draft if exists
    var draft = localStorage.getItem('teacher_assignment_draft');
    if (draft) {
    ...
    form.addEventListener('submit', function() {
        localStorage.removeItem('teacher_assignment_draft');
    });
});
</script>
<?= $this->endSection() ?>
